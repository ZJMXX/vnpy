...
for i in symbol_exchange_dict.items():
    ...
    manager_engine.output_data_to_csv(file_path=file_path, symbol=i[0], exchange=i[1], interval=Interval.DAILY,
                                      start=datetime(2000, 1, 1, 0, 0, 0), end=datetime(2099, 12, 31))
